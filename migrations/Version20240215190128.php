 ...
 */
final class Version20240215190128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon ADD COLUMN statut VARCHAR(255)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__lecon AS SELECT id, professeur_id, nom, description FROM lecon');
        ...
        $this->addSql('INSERT INTO lecon (id, professeur_id, nom, description) SELECT id, professeur_id, nom, description FROM __temp__lecon');
